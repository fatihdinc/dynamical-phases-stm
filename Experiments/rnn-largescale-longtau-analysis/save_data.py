...
for k in range(lr_all.shape[0]):
    ...
    for l in tqdm((range(21))):
        ...
        for i in range(n_exp):
            ...
            f = np.load(f'./results_longertau/lr{learning_rate}_delay_{delay_interval}/process_{i}/training_details.npz')
...
np.savez('longtau.npz',classes=classes,losses=losses,rels=rels,accs=accs,psd_ratios=psd_ratios)
